        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <div>
                        <a class="btn btn-link" href="/view/orders/list/create">Create
                            New Order</a>
                    </div>
                </div>
                <div class="box-body">
                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            <table id="new-orders-table" class="table table-bordered table-striped">
                                <thead>
                                <tr>
                                    <th>Customer Name</th>
                                    <th>Order Date</th>
    ...
    $('#new-orders-table').DataTable({
      ...
      buttons: [
        'print',
        {
          ...
          filename: 'New Orders List',
          title: 'New Orders Data'
        },
        {
          extend: 'excelHtml5',
          exportOptions: {
            ...
            success: function (data)   // A function to be called if request succeeds
            {
              ...
              if (JSON.stringify(data['status_code'] == 200)) {
                ...
                swal({
                  ...
                  $('#new-orders-table').DataTable().ajax.reload()
