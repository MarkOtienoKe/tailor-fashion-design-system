    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Role Matrix Panel</li>
            </ol>
        </section>
            ...
            <div class="box">
                        ...
                        <div class="box-body">
                            <div class="visible-xs alert alert-danger">
                                ...
                                This page might not be formatted properly for this screen due to the complexity of Role
                                Based Access Control permissioning.
                            </div>

                            {!! Form::open( ['class' => 'form-horizontal role_matrix_update_form'] ) !!}
                    ...
                    <i class="fa fa-arrow-right"></i>
                                    ...
                                    @foreach($perms as $p)
                                        <tr>
                                            <th class="alert-warning">
                                                <a href="{{ route('permission.show',$p->id) }}">
                                                    <button type="button" class="btn btn-warning btn-xs"><span
                                                                class="glyphicon glyphicon-link"></span></button>
                                                </a>
                                                {{ $p->name }}
                                            ...
                                            @for ($i=0; $i < $roles->count(); $i++ )
                                                <td data-container="body" data-trigger="focus" data-toggle="popover"
                                                    data-placement="left"
                            ...
                            @if ( Shinobi::can( config('admin.acl.role.rolematrix', false) ) )
                                <div class="form-group">
                                    <div class="col-sm-3">
                                        {!! Form::submit('Save Role Permission Changes', ['class' => 'btn btn-primary form-control update_role_matrix_btn']) !!}
                                    </div>
                                </div>
                            @else
                                <div class="alert alert-danger lead">
                                    <i class="fa fa-exclamation-triangle fa-1x"></i> You are not permitted to sync role
                                    permissions.
                                </div>
                            @endif
                            {!! Form::close() !!}
...
<script>
  $('.update_role_matrix_btn').on('click', function (event) {
    ...
    var serializedData = $('.role_matrix_update_form').serialize()
