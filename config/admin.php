    ...
    */
    'views' => [
        'layouts' => [
            ...
            'flash'         => 'admin.partials.flash',
            'modal'         => 'admin.partials.modal',
            'search'        => 'admin.partials.search',
            'dashboard'     => 'admin.partials.index',
            'adminlinks'    => 'admin.links',
            'unauthorized'  => 'admin.partials.unauthorized',
        ],
        ...
        'roles' => [
            ...
            'create'    => 'admin.partials.create',
            'show'      => 'admin.partials.edit',
            'edit'      => 'admin.partials.edit',
